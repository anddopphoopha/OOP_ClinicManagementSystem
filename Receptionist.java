...
public class Receptionist extends ClinicSystem implements ClinicStaff {
	...
	public boolean checkDuplicate(String firstname, String lastname, String username)
			throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException,
			SecurityException, ClassNotFoundException {
		readLines(this, userPath(), getMethodObject("clinic.Receptionist", "readUserInfo"), firstname, lastname,
	...
	public void displayDoctorList() throws NoSuchMethodException, SecurityException, IllegalAccessException,
		...
		readLines(this, userPath(), getMethodObject("clinic.Receptionist", "readDoctorList"), null, null, null, null,
				null, null);
	...
	public void displayPatientList() throws NoSuchMethodException, SecurityException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, ClassNotFoundException {
		readLines(this, userPath(), getMethodObject("clinic.Receptionist", "readPatientList"), null, null, null, null,
				null, null);
	...
	public void viewAppointmentOfSpecificDoctorAndDate(String doctor, String date)
		...
		readLines(this, appointmentPath(),
				getMethodObject("clinic.Receptionist", "readAppointmentOfSpecificDoctorAndDate"), doctor, date, null,
				null, null, null);
	}
	...
	public void viewAppointmentByDuration(String date1, String date2)
			throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException,
			SecurityException, ClassNotFoundException {
		readLines(this, appointmentPath(), getMethodObject("clinic.Receptionist", "readAppointmentByDuration"), date1,
				date2, null, null, null, null);
	}
	...
	public void readAppointmentByDuration(String readLine, String date1, String date2, String keyword3, String keyword4,
		...
		if (tempDate1.before(tempDate2)) {
			if ((checkDate.after(tempDate1) || checkDate.equals(tempDate1))
				...
				System.out.println(readLine);
		} else if ((checkDate.after(tempDate2) || checkDate.equals(tempDate2))
	...
	public void displayAppointment() throws NoSuchMethodException, SecurityException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, ClassNotFoundException {
		readLines(this, appointmentPath(), getMethodObject("clinic.Receptionist", "getAppointment"), null, null, null,
				null, null, null);
